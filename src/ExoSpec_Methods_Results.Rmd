...
MassSpec <- MassSpec %>% 
   select(Sample_ID, Cancer_Peptides, Non_Cancer_Peptides) %>% 
...
NanoGenes <- names(NanoString)[1:167]
#Grab the names of all the peptides...
Peptides <- c(Cancer_Peptides, Non_Cancer_Peptides)
```
...
*A priori* filtering of peptides was undertaken by only retaining peptides quantified in at least 30% of either cancer or non-cancer samples.
